...
ActiveRecord::Schema.define(version: 20_210_316_211_616) do
  ...
  create_table 'contents', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[purchasable_type purchasable_id], name: 'index_contents_on_purchasable_type_and_purchasable_id'
  end
